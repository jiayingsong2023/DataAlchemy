...
def main():
    ...
    if is_linux:
        ...
        print(
            f"⚠️  Warning: This script is optimized for Linux. Detected platform: {platform.system()}"
        )
        print()
    ...
    if pytorch_ok:
        ...
        if is_linux:
            ...
            print(
                "   uv sync  # or: pip install torch torchvision --index-url https://download.pytorch.org/whl/rocm7.1"
            )
        else:
