...
| M2 | 第 11～18 周 | 分层记忆与检索收敛 | 智能体跨会话记住正确、可追踪、可删除的信息 | PostgreSQL 唯一路径验证通过，跨租户泄漏为零 |
| M3 | 第 19～30 周 | 可试点智能体 | 完成模拟预演，可作为发布候选交付 | 双 tenant 四周预演、工程评测与恢复门禁通过 |
| M4 | M3 发布候选后 | 企业治理与可控学习 | 记忆、工具、模型和发布均可治理、可回滚 | 工程发布候选和两个安全发布周期通过；真实验收留待正式试点 |
