...
_FROZEN_RTD_Q4 = {
    ...
    "令狐冲用什么剑理控制红色晶石中的狂暴能量？": (
        ...
        "破气式控制并驯服了狂暴的火系魔素",
        "他想起了独孤九剑的“破气式”。破气式讲究寻找对方真气运转的弱点，顺势而为，借力打力。"
        "他尝试用自己那微弱但精纯的“易筋经魔素”去引导这股狂暴的火系能量，不再强行压制，"
        "而是寻找其流动的“势”。奇迹发生了。那狂暴的火系魔素，在他的引导下，渐渐变得驯服",
    ),
    "令狐冲循着什么气味找到了冒险者营地？": (
        3,
    ...
    "令狐冲用炎爆攻击哥布林造成了什么结果？": (
        ...
        "炎爆瞬间吞噬了十几只哥布林",
        "强大的冲击波和高温火焰瞬间将十几只哥布林吞噬。这不是他之前那种小打小闹的“破爆式”，"
        "这是他结合了更多剑理，威力更强，也更“写意”的炎爆",
    ),
    "令狐冲对付魔化野狼时想起并使用了哪一式？": (
        5,
    ...
    "令狐冲用什么剑理瓦解古神祭坛的黑色心脏？": (
        ...
        "用总诀式瓦解了黑色心脏",
        "他要用他所理解的“总诀式”，来献祭这邪恶的根源。他将体内所有的火系魔素，以及从这个"
        "世界吸收的各种驳杂能量，甚至是他作为史莱姆的生命本源，都开始以“总诀式”的玄奥法门"
        "进行压缩、融合、提纯。他的身体发出刺目的红光，周围的温度急剧升高。空气因高温而扭曲，"
        "地面开始熔化。黑袍教徒们惊恐地看着这只小小的史莱姆，仿佛在看一个即将爆发的火山。"
        "#第九章：美好的炎爆，净化与新生“为了这个世界……也为了我心中的那份快意恩仇！”令狐冲的"
        "意识中闪过这个念头。下一刻，一道前所未有，超越了单纯“炎爆”范畴的能量洪流，从他小小的"
        "身体中喷薄而出。那不是单纯的火焰，那光芒炽烈而纯净，带着一种一往无前、净化一切的“意”。"
        "它没有固定的形态，却仿佛包含了独孤九剑所有招式的变化——时而如“破剑式”般锋锐无匹，"
        "时而如“破枪式”般一往无前，时而如“破索式”般灵动精巧。这道能量洪流没有直接摧毁祭坛，"
        "而是以一种玄妙的方式，渗透、瓦解了黑色心脏晶体的结构",
    ),
    "故事结尾人们如何称呼令狐冲？": (
        7,
...
def _frozen_rtd_q4_response(
    ...
    return {
        "answer": f"根据文档：{frozen['evidence'][0][1]}",
        "citations": [
